...
$query = "SELECT * FROM blog_content ORDER BY id ASC";
...
<div class="container-fluid p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h3 mb-0 text-gray-800">Manage Blog Content</h2>
        <a href="add_blog_content.php" class="btn btn-primary shadow-sm">
