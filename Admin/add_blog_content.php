...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['section_name'])) {
    ...
    $check_query = "SELECT id FROM blog_content WHERE section_name = '$section_name'";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
            ...
            if (in_array($file_ext, $allowed)) {
                ...
                $error = "Invalid image format. Only JPG, JPEG, PNG, GIF, SVG are allowed.";
            }
        }

        if (!isset($error)) {
            $insert_query = "INSERT INTO blog_content (section_name, title, description, image, link) 
                             VALUES ('$section_name', '$title', '$description', '$image', '$link')";
            if (mysqli_query($connection, $insert_query)) {
                echo "<script>window.location.href='blog_content.php?msg=" . urlencode("Content added successfully") . "';</script>";
                exit();
            } else {
...
<div class="container-fluid p-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h3 mb-0 text-gray-800">Add Blog Page Content Section</h2>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="section_name" required 
                                placeholder="e.g. hero, testimonial_1, testimonial_2">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="title" required 
                                placeholder="e.g. Blog, Maria Jones">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Upload a profile picture or hero image.</small>
                        </div>
